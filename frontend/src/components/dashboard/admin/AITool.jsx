...
export default function AITool() {
  ...
  const handleGenerate = () => {
    ...
    // Mock API call
    setTimeout(() => {
      setResult(`🚀 Transform your business with Sarvam Digital! We provide cutting-edge solutions tailored for your growth. #Innovation #Tech #GrowthHacking\n\nHere are 3 tips for success:\n1. Leverage AI driven insights.\n2. Optimize your sales funnel.\n3. Build a robust online presence.`);
    ...
    <div className="space-y-6 animate-fade-in max-w-4xl">
      <div className="border-b border-white/10 pb-4">
        <h2 className="text-2xl font-bold flex items-center gap-2">
          <Bot className="text-primary" /> AI Generation Tool
        </h2>
        <p className="text-foreground/70 mt-1">Generate marketing copy, social media captions, and ideas instantly.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass p-6 rounded-xl border border-white/10 shadow-xl space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2 text-foreground/80">Select Tool</label>
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-foreground/80">Topic or Prompt</label>
            <textarea 
              rows="5" 
              placeholder="E.g., A promotional post for our new SEO optimization service targeting small businesses..." 
        ...
        <div className="glass p-6 rounded-xl border border-white/10 shadow-xl flex flex-col">
          <div className="flex justify-between items-center mb-4">
            <label className="block text-sm font-medium text-foreground/80">Generated Output</label>
            {result && (
